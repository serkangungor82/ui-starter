...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (e === "google_not_configured") setError("Google girişi henüz aktif değil.");
    if (e === "github_not_configured") setError("GitHub girişi henüz aktif değil.");
    if (e === "microsoft_not_configured") setError("Microsoft girişi henüz aktif değil.");
  }, [searchParams]);
    ...
    <div className="flex flex-1 items-center justify-center bg-background px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 text-card-foreground shadow-sm">
          <h1 className="mb-6 text-2xl font-bold">{t("login_title")}</h1>
          ...
          <div className="flex flex-col gap-2 mt-4">
            <a
              ...
              className="flex items-center justify-center gap-3 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-medium text-foreground hover:bg-muted transition-colors"
            >
